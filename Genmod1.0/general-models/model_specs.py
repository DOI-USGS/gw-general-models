...
#---------------------------------------------------------------------------------------------------------------
#Glacial Environments and Surficial Sediments (GESS) geodatabase used for mapping geologic units (field “CrseStratSed” from 
#dataset “GESS_poly.gdb”) to either fine (CrseStratSed = 0) or coarse (CrseStratSed = 1) sediments, which were then used 
#to define zones of hydraulic conductivity.
#   Available at: https://doi.org/10.5066/F71R6PQG 
#   Create a folder named "Geology" and download the geodatabase file "GESS_poly.gdb" to it.
#
#Path and actual file name in the "/input-data" folder for the (GESS) geodatabase is below:
#        /Geology/GESS_poly.gdb
#
#---------------------------------------------------------------------------------------------------------------
...
#Method for geology mapping to zone number from dataset GESS_poly.gdb in "Glacial Environments and Surficial Sediments (GESS) 
#Geodatabase for the Glaciated, Conterminous United States", https://doi.org/10.5066/F71R6PQG
#            Haj, Adel E., Soller, David R., Buchwald, Cheryl A., Kauffman, Leon J., Heisig, Paul, M., and Reddy, James, 2018, 
#            Databases used to develop a hydrogeologic framework for Quaternary sediments in the glaciated conterminous 
#            United States: U.S. Geological Survey data release, https://doi.org/10.5066/F71R6PQG
