...
#used for landcover used in nb5       published  NOT USED FOR WRR
...
#finds tif files in all subdirectories in each below    MOHP AND MOHP2 NOT USED IN WRR, INCLUDES THIES2
...
# is pour_dir part of mohp download?  MERGED NOT USED IN WRR
